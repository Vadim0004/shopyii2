    ...
    <div class="row">
        ...
        <table class="table-bordered table-striped table">
            ...
            <tr>
                ...
                <td><?php echo Productorderrepository::getNameStatusOrder($orderArray['status']); ?></td>
            <?php endforeach; ?>
            </tr>    
        </table>
                ...
                <?php foreach ($products as $idProduct => $product): ?>
                    ...
                    <?php foreach ($product as $productId ): ?>
                        ...
                        <?php echo 'Общая цена купленных продуктов' . ' ' . '<b>' . Productrepository::totalPriceProducts($arrayProductsFromOrder[$idProduct][$productId->id], $productId->price) . '</b>' . '</br>'; ?>
                    <?php endforeach; ?>
                <?php endforeach; ?>
